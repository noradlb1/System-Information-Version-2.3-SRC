...
#Region " Public Methods "
    ...
    Public Sub DropDownControl(ByVal control As Control) Implements IWindowsFormsEditorService.DropDownControl
        ...
        Dim PickerForm As Control = WindowsFormsEditorService.GetParentForm(_Owner)
...
#Region " Private Methods "
    ...
    Private Sub DoModalLoop()
        ...
        Do While _DropDownHolder.Visible
            ...
            If SafeNativeMethods.MsgWaitForMultipleObjects(1, IntPtr.Zero, 1, 5, 255) = &HFFFFFFFF Then
                Debug.WriteLine("DoModalLoop: MsgWaitForMultipleObjects failed.")
            End If
        Loop
    End Sub
    ...
    Private Shared Function GetParentForm(ByVal ctl As Control) As Control
        Do
...
#Region " DropDownForm Class (Nested) "
...
Friend Class SafeNativeMethods
    ...
    Friend Shared Function MsgWaitForMultipleObjects(ByVal nCount As Int32, ByVal pHandles As IntPtr, _
                                                      ByVal bWaitAll As Int16, ByVal dwMilliseconds As Int32, _
