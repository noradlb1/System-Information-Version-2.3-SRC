...
#Region " Protected Properties "
    ...
    Protected Overridable ReadOnly Property DownButtonSize() As Size
        Get
            ...
            Dim hBitmap As IntPtr = NativeMethods.LoadBitmap(IntPtr.Zero, New IntPtr(OBM_DNARROW))
...
#Region " Protected Methods "
    ...
    Protected Overridable Sub GetDisplayLayout(ByRef colorBoxRect As Rectangle, _
                                               ByRef textBoxRect As RectangleF, ByRef buttonRect As Rectangle)
...
Friend Class NativeMethods
    ...
    Friend Shared Function LoadBitmap(ByVal hInstance As IntPtr, ByVal pBitmapName As IntPtr) As IntPtr
    End Function
